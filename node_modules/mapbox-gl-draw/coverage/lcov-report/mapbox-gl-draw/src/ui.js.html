...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const xtend = require('xtend');
...
&nbsp;
  function updateMapClasses() {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ctx.container) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
  function createControlButton(id, options = <span class="cstat-no" title="statement not covered" >{})</span> {
...
&nbsp;
      ...
      if (clickedButton === activeButton) <span class="missing-if-branch" title="if path not taken" >I</span>{
<span class="cstat-no" title="statement not covered" >        deactivateButtons();</span>
