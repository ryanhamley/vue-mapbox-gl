  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>90/95</span>
      </div>
      <div class='fl pad1y space-right2'>
...
&nbsp;
  events.keydown = function(event) {
    ...
    else if (isKeyModeValid(event.keyCode)) <span class="missing-if-branch" title="if path not taken" >I</span>{
<span class="cstat-no" title="statement not covered" >      currentMode.keydown(event);</span>
    ...
    else if (event.keyCode === 51 &amp;&amp; ctx.options.controls.polygon) <span class="missing-if-branch" title="else path not taken" >E</span>{
      changeMode(Constants.modes.DRAW_POLYGON);
    }
  };
&nbsp;
  events.keyup = function(event) {
    if (isKeyModeValid(event.keyCode)) <span class="missing-if-branch" title="else path not taken" >E</span>{
