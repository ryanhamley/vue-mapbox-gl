...
<html lang="en">
<head>
    <title>Code coverage report for mapbox-gl-draw/src/modes/simple_select.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">mapbox-gl-draw/src/modes/</a> simple_select.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  const stopExtendedInteractions = function() {
    if (boxSelectElement) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (boxSelectElement.parentNode) boxSelectElement.parentNode.removeChild(boxSelectElement);
...
&nbsp;
        ...
        if (isFeatureSelected &amp;&amp; isShiftClick) {
          ...
          if (selectedFeatureIds.length === 1 ) <span class="missing-if-branch" title="else path not taken" >E</span>{
            doubleClickZoom.enable(ctx);
          }
        ...
        } else if (!isFeatureSelected &amp;&amp; !isShiftClick) <span class="missing-if-branch" title="else path not taken" >E</span>{
