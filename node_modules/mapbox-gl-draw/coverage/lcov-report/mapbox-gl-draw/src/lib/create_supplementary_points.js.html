...
<html lang="en">
<head>
    <title>Code coverage report for mapbox-gl-draw/src/lib/create_supplementary_points.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">mapbox-gl-draw/src/lib/</a> create_supplementary_points.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const createVertex = require('./create_vertex');
...
&nbsp;
  if (type === Constants.geojsonTypes.POINT) {
    ...
    coordinates.forEach((line, lineIndex) =&gt; {
      processLine(line, <span class="branch-0 cbranch-no" title="branch not covered" >(basePath) ? <span class="cstat-no" title="statement not covered" >`${basePath}.${lineIndex}` </span>: String(lineIndex))</span>;
    });
  } else if (type === Constants.geojsonTypes.LINE_STRING) {
    processLine(coordinates, basePath);
  } else if (type.indexOf(Constants.geojsonTypes.MULTI_PREFIX) === 0) <span class="missing-if-branch" title="else path not taken" >E</span>{
