...
<span class="cline-any cline-yes">53×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var isEqual = require('lodash.isequal');
...
&nbsp;
      if (ctx.store.get(feature.id) === undefined || ctx.store.get(feature.id).type !== feature.geometry.type) {
        ...
        if (!isEqual(internalFeature.getCoordinates(), feature.geometry.coordinates)) <span class="missing-if-branch" title="if path not taken" >I</span>{
<span class="cstat-no" title="statement not covered" >          internalFeature.incomingCoords(feature.geometry.coordinates);</span>
        }
      }
      return feature.id;
    });
