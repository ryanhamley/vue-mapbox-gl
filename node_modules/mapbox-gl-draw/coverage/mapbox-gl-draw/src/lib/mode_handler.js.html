...
<html lang="en">
<head>
    <title>Code coverage report for mapbox-gl-draw/src/lib/mode_handler.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">mapbox-gl-draw/src/lib/</a> mode_handler.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var ModeHandler = function(mode, DrawContext) {
&nbsp;
  var handlers = {
    drag: [],
    click: [],
